		...
		<div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col">
						...
						content={
							<div className="text-black">
								...
								<ul className="space-y-1">
									<li>
										⏱️ Reducción del tiempo de auditoría: <b>45%</b>
									</li>
									<li>
										💰 Disminución de costos: <b>30%</b>
									</li>
									<li>
										📊 ROI esperado: <b>1.8 en 6 meses</b>
									</li>
									<li>
										✅ Mejora en precisión de informes: <b>+25%</b>
									</li>
								</ul>
							</div>
						}
			...
			<footer className="bg-indigo-700 text-white py-8 mt-10 text-center">
				...
				<p className="mt-2 text-indigo-200">
					...
					<span className="font-semibold">Daniel Estevez - Universidad Libre - 2025</span>
				</p>
			</footer>
		</div>
	);
